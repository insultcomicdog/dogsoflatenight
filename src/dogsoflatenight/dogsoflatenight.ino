...
char twitterSearchTerms[] = "insultcomicdog%20OR%20formetopoopon%20OR%20for%20me%20to%20poop%20on%20-RT";


float since_id = 0;
float totalnumsearchresults = 0;
...
//      Serial.println();
    ...
    client.print(since_id); //this works
    //client.print("0"); //this works
    //client.print(since_id_str); //this launches board into rest cycle
    client.print("&track=");
    ...
    sjSerial.println("Polling Twitter for poop.");
  ...
  float totalnumsearchresults = atof(totalnumsearchresults_str);
